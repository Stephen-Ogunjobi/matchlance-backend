...
import { postSignup, postLogin, postRefresh, postLogout, postResetPassword, postNewPassword, verifyEmail, resendVerificationEmail, getCurrentUser, } from '../controllers/auth.js';
dotenv.config();
// Mock email services
...
const createMockReq = (body = {}, cookies = {}, query = {}, user) => ({
    body,
    cookies,
    query,
    user,
...
describe('Authentication System', () => {
    ...
    describe('POST /refresh - Token Refresh', () => {
        ...
        it('should return 403 if refresh token does not match database', async () => {
            const differentToken = jwt.sign({ userId }, process.env.JWT_REFRESH_SECRET || 'test-secret', { expiresIn: '7d' });
