...
import { addOnlineUser, removeOnlineUser, getAllOnlineUsers, } from "./socket/onlineUsers.js";
import { handleJoinConversation, handleLeaveConversation, handleSendMessage, handleTyping, handleMarkAsRead, } from "./socket/handlers/index.js";
dotenv.config();
...
export const initializeSocket = (server) => {
    ...
    io.on("connection", async (socket) => {
        ...
        socket.on("join_conversation", (data) => handleJoinConversation(socket, io, data));
