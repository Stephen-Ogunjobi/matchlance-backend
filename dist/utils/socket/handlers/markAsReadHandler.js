...
export const handleMarkAsRead = async (socket, io, data) => {
    ...
    try {
        ...
        const isParticipant = cachedConversation.participants.some((p) => p.toString() === userId.toString());
        if (!isParticipant) {
            socket.emit("error", { message: "Conversation not found" });
            return;
        }
...
//# sourceMappingURL=markAsReadHandler.js.map