...
import { getCurrentUser, handleGoogleCallback, initiateGoogleAuth, postLogin, postLogout, postNewPassword, postRefresh, postResetPassword, postSignup, resendVerificationEmail, verifyEmail, verifyLogin, } from "../controllers/auth.js";
...
router.post("/resend-verification", rateLimiter("resendVerification"), resendVerificationEmail);
